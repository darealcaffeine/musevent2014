...
ActiveRecord::Schema.define(:version => 20130108114315) do

  create_table "amazon_processors", :force => true do |t|
  ...
  create_table "dummy_processors", :force => true do |t|
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end
  ...
  add_index "payments", ["processor_id", "processor_type"], :name => "index_payments_on_processor_id_and_processor_type"
